    ...
    return (<>
        <div className="flex font-sans">
            <div className="flex-none w-auto relative">
                <h1 className="flex-auto p-6 font-bold text-4xl">
                    Les téléphones
                </h1>
            </div>
        ...
        <div className='grid grid-rows-2 grid-flow-row grid-cols-3 gap-4 mt-2 px-8 mb-8'>
            <div className="cardItems bg-white w-auto h-auto p-4 rounded-lg shadow">
                <div className="title font-semibold text-xl px-2">
                    Lumin X</div>
                ...
                <div className="bottom flex flex-col justify-center">
                    <div className="description mt-2 text-base">
                    ...
                    <div className="flex mt-2 font-semibold text-lg">859 €</div>
            ...
            <div className="cardItems bg-white w-auto h-auto p-4 rounded-lg shadow">
                <div className="title font-semibold text-xl px-2">
                    PixelWave 14</div>
                <div className="top flex justify-center">
                    <img className="w-[125px] h-[200px] object-cover" src="src/app/assets/test/PixelWave_blanc.png" alt="image1" />
                </div>
                <div className="bottom flex flex-col justify-center">
                    <div className="description mt-2 text-base">
                        Qui laborum enim optio corporis magnam. Et non quia numquam est dolor qui.
                    ...
                    <div className="flex mt-2 font-semibold text-lg">1329 €</div>
                    <div className="flex justify-center mt-4">
                        <button className="h-10 px-6 btn-third rounded-3xl" type="button">
                            Ajouter au panier
                        </button>
            ...
            <div className="cardItems bg-white w-auto h-auto p-4 rounded-lg shadow">
                <div className="title font-semibold text-xl px-2">
                    Aurora Max</div>
                <div className="top flex justify-center">
                    <img className="w-[125px] h-[200px] object-cover" src="src/app/assets/test/AuroraMax_rose.png" alt="image1" />
                </div>
                <div className="bottom flex flex-col justify-center">
                    <div className="description mt-2 text-base">
                        Qui laborum enim optio corporis magnam. Et non quia numquam est dolor qui.
                    ...
                    <div className="flex mt-2 font-semibold text-lg">909 €</div>
                    <div className="flex justify-center mt-4">
                        <button className="h-10 px-6 btn-third rounded-3xl" type="button">
                            Ajouter au panier
                        </button>
            ...
            <div className="cardItems bg-white w-auto h-auto p-4 rounded-lg shadow">
                <div className="title font-semibold text-xl px-2">
                    Nova SE</div>
                <div className="top flex justify-center">
                    <img className="w-[125px] h-[200px] object-cover" src="src/app/assets/test/NovaSE_noir.png" alt="image1" />
                </div>
                <div className="bottom flex flex-col justify-center">
                    <div className="description mt-2 text-base">
                        Qui laborum enim optio corporis magnam. Et non quia numquam est dolor qui.
                    ...
                    <div className="flex mt-2 font-semibold text-lg">629 €</div>
                    <div className="flex justify-center mt-4">
                        <button className="h-10 px-6 btn-third rounded-3xl" type="button">
                            Ajouter au panier
                        </button>
            ...
            <div className="cardItems bg-white w-auto h-auto p-4 rounded-lg shadow">
                <div className="title font-semibold text-xl px-2">
                    Connexis Pro</div>
                <div className="top flex justify-center">
                    <img className="w-[125px] h-[200px] object-cover" src="src/app/assets/test/ConnexisPro_jaune.png" alt="image1" />
                </div>
                <div className="bottom flex flex-col justify-center">
                    <div className="description mt-2 text-base">
                        Qui laborum enim optio corporis magnam. Et non quia numquam est dolor qui.
                    ...
                    <div className="flex mt-2 font-semibold text-lg">1019 €</div>
                    <div className="flex justify-center mt-4">
                        <button className="h-10 px-6 btn-third rounded-3xl" type="button">
                            Ajouter au panier
                        </button>
            ...
            <div className="cardItems bg-white w-auto h-auto p-4 rounded-lg shadow">
                <div className="title font-semibold text-xl px-2">
                    OnePulse</div>
                <div className="top flex justify-center">
                    <img className="w-[125px] h-[200px] object-cover" src="src/app/assets/test/OnePulse_rouge.png" alt="image1" />
                </div>
                <div className="bottom flex flex-col justify-center">
                    <div className="description mt-2 text-base">
                        Qui laborum enim optio corporis magnam. Et non quia numquam est dolor qui.
                    ...
                    <div className="flex mt-2 font-semibold text-lg">559 €</div>
                    <div className="flex justify-center mt-4">
                        <button className="h-10 px-6 btn-third rounded-3xl" type="button">
                            Ajouter au panier
                        </button>
